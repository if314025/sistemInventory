 ...
 * @author Okta
 */
public class makananui extends javax.swing.JFrame {
    ...
    private void loadTabelBarang()
    {
        ...
        try
        {
           String query = "SELECT * FROM menu  WHERE kategori_menu = 'makanan'";
    ...
    private void tambahDataBarang(String nama, String tanggal, String status, String username)
    {
        try
        {
            ...
            JOptionPane.showMessageDialog(null, "Menu berhasil dipesan,silahkan pantau pesanan anda di menu pesanan.");
